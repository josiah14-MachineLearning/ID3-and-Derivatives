...
def run_dtree_model(dtree,  # type: Tuple[str, Dict[Any, Any]]
     row  # type: Series
    ):
# type: (...) -> Series
    """
...
spam_prediction_model = id3('SpamClass', spam_analysis_df)
print()
(print)(spam_prediction_model)
print()
(print)(spam_analysis_df.apply(_coconut.functools.partial(run_dtree_model, spam_prediction_model), axis=1))
...
eco_veg_model = id3('Vegetation', ecological_vegetation_df)
print()
(print)(eco_veg_model)
print()
(print)(ecological_vegetation_df.apply(_coconut.functools.partial(run_dtree_model, eco_veg_model), axis=1))
...
bladder_inflammations_model = (id3('BladderInflammation', acute_inflammations_id3_predict_bladder_inflammation_df))
print()
(print)(bladder_inflammations_model)
print()
((print)(acute_inflammations_id3_predict_bladder_inflammation_df.apply(_coconut.functools.partial(run_dtree_model, bladder_inflammations_model), axis=1)))
...
nephritis_model = (id3('RenalPelvisNephritis', acute_inflammations_id3_predict_nephritis_df))
print()
(print)(nephritis_model)
print()
((print)(acute_inflammations_id3_predict_nephritis_df.apply(_coconut.functools.partial(run_dtree_model, nephritis_model), axis=1)))
